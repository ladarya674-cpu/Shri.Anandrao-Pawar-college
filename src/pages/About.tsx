      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-blue-100 text-xs sm:text-sm mt-2 max-w-2xl leading-relaxed">
            Shriram Education Society's Shri. Anandrao Pawar Arts, Commerce and
            Science Mahavidyalaya, Chiplun.
          </p>
        </div>
      </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center mb-16">
          <div className="lg:col-span-7 space-y-4">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              Shri. Anandrao Pawar Arts, Commerce and Science Mahavidyalaya,
              Kanganewadi, Khend, Chiplun was established in 2018-19 under the
              aegis of <strong>Shriram Education Society, Chiplun</strong> to
              provide accessible and quality higher education to students of
              Chiplun Taluka.
            </p>
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              The college offers Junior College (11th & 12th) in Arts, Commerce,
              and Science streams approved by the{" "}
              <strong>Maharashtra State Board</strong>, as well as Senior
              College (Degree) courses affiliated to the{" "}
              <strong>University of Mumbai</strong> and accredited by{" "}
              <strong>NAAC</strong>.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-3">
              <div className="rounded-2xl p-5 border border-amber-200 bg-amber-50/70 shadow-sm">
                ...
                <p
                  className="text-3xl sm:text-4xl font-bold text-[#1e3764]"
                  style={{ fontFamily: "Fraunces, Georgia, serif" }}
                >
                  200
                </p>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {f.points.map((p, i) => (
                      <li
                        key={i}
                        className="text-slate-600 text-xs sm:text-sm leading-relaxed flex gap-2.5"
                      >
                        <span
                          style={{ color: "#e07b00" }}
        ...
        <section className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm">
          <div className="text-center max-w-2xl mx-auto mb-6">
            ...
            <p className="text-xs sm:text-sm text-slate-500">
              Student welfare cells and activity councils supporting holistic
              development.
            </p>
          </div>
