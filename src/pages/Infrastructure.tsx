      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-blue-100 text-xs sm:text-sm mt-2 max-w-2xl leading-relaxed">
            State-of-the-art facilities designed to foster an inspiring,
            disciplined, and technologically equipped educational atmosphere.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-slate-600 text-xs sm:text-sm sm:leading-relaxed">
            Our campus at Kanganewadi, Khend, Chiplun spans well-ventilated
            classrooms, high-tech laboratories, an expansive library, and
            student amenity zones tailored to both Higher Secondary (11th &
            12th) and Undergraduate Degree programs.
          </p>
        </div>
