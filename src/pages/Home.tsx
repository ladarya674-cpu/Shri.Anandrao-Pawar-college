...
const stats = [
  ...
  { value: "Grade C", label: "NAAC Accredited", icon: "⭐" },
]
  ...
  return (
    <div className="bg-slate-50 text-slate-800">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
            ...
            <div className="lg:col-span-8">
              ...
              <p className="text-slate-600 text-sm sm:text-base leading-relaxed mb-3">
                Established in 2018-19, Shri. Anandrao Pawar College is a
                premier institution in Chiplun Taluka dedicated to academic
                excellence, disciplined education, and rural empowerment in the
                Konkan region.
              </p>
              <p className="text-slate-600 text-sm leading-relaxed mb-6">
                Affiliated with the prestigious{" "}
                <strong>University of Mumbai</strong> and accredited with{" "}
                <strong>NAAC 'C' Grade</strong>, the college offers
                comprehensive curricula across Arts, Commerce, and Science
                disciplines for both Junior College and Undergraduate degrees.
              </p>
            ...
            <div className="lg:col-span-4">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(145deg, #1e3764 0%, #0d2444 100%)",
                }}
              >
                <h3
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="flex items-center gap-3 bg-white/10 rounded-xl p-2.5 border border-white/10">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[11px] text-blue-100 truncate">
                        Approved Junior College (11th & 12th)
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div
        ...
        className="border-y border-amber-500/40"
      >
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {stats.map((s) => (
              <div
                key={s.label}
                className="text-center p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
            ...
            <div className="lg:col-span-7 bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-sm flex flex-col justify-between">
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-start my-4">
                  ...
                  <div className="flex-shrink-0 mx-auto sm:mx-0">
                    <div className="w-32 h-40 sm:w-36 sm:h-44 rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 border-2 border-amber-300 p-2 flex flex-col items-center justify-center text-center shadow-inner relative overflow-hidden group">
                      ...
                      <span className="text-xs font-bold text-[#1e3764]">
                        Office of the
                      </span>
                  ...
                  <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
                    <p className="italic text-slate-700 bg-amber-50/60 p-3 rounded-xl border-l-4 border-amber-500">
                      ...
                      the ignition of intellect, character building, and social
                      responsibility."
                    </p>
                    <p>
                      Welcome to Shri. Anandrao Pawar Arts, Commerce and Science
                      Mahavidyalaya, Kanganewadi, Khend, Chiplun. Under the
                      visionary stewardship of{" "}
                      <strong>Shriram Education Society</strong>, our
                      institution has been fostering student potential since
                      2018.
                    </p>
                    <p>
                      We strive to create an academic environment embedded with
                      sincerity, discipline, and modern pedagogical rigor,
                      ensuring that our students excel in University
                      examinations, competitive arenas, and societal leadership.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                <div>
                  <h4 className="font-bold text-sm sm:text-base text-[#1e3764]">
                    Principal
                  </h4>
                ...
                <div className="divide-y divide-slate-100 flex-1 overflow-y-auto max-h-[380px]">
                  {loading ? (
                    <div className="p-8 text-center text-slate-400">
                      <div className="animate-spin inline-block w-6 h-6 border-2 border-slate-200 border-t-[#1e3764] rounded-full mb-2" />
                    ...
                    <div className="p-8 text-center text-slate-500">
                      <p className="text-xs font-medium">No notices available at the moment.</p>
                    </div>
                  ) : (
                    notices.map((n) => {
                      const { day, month } = formatDateBadge(n.uploadedAt)
                      return (
                        <Link
                          key={n.id}
                          to="/notices"
            ...
            {[
              {
                ...
                tag: "Reading Hall & Books",
              },

              {
                img: computerLabPhoto,
                title: "Computer Laboratory",
                tag: "High Speed Desktops",
              },

              {
                img: chemLabPhoto,
                title: "Chemistry Laboratory",
                tag: "Science Practical",
              },

              {
                img: seminarHallPhoto,
                title: "Seminar Hall",
                tag: "Digital Audio-Visual",
              },
            ].map((facility) => (
              <div
                key={facility.title}
